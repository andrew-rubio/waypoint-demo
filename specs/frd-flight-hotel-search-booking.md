...
- **FR-005-3** Flight options show airline, route, duration, stops, and whether the price is per traveller. Hotel options show name, rating, nightly rate, and whether taxes/fees are included.
