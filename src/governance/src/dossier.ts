...
const CONTROL_TESTS: Record<string, string> = {
  'RAI-HITL-001': 'recorded-sample evidence (booking app segment)',
  'RAI-OUT-001': 'recorded-sample evidence (booking app segment)',
  ...
  'DATA-FRESH-001': 'recorded-sample evidence (budget/currency app segment)',
  'EVAL-GRD-001': 'eval/gate.json grounding evaluators + eval:demo-fail/pass',
  'EVAL-HITL-001': 'recorded-sample evidence (booking app segment)',
  'OPS-TRACE-001': 'agent-spans.test.ts (gen_ai.conversation.id)',
  'OPS-VER-001': 'agent-spans telemetry (model captured)',
